...
# For setting timber moisture class according to swiss standards
class TimberMoistureClass():
    def __init__(self,
        ...
        Args:
            ...
            assigned_to_objects (str): Assigned Objects
            moisture_class (enum): Moisture class to be assigned
        ...
        # Assigned Objects
        clientObject.assigned_to_objects = assigned_to_objects

        # Setting the moisture class
